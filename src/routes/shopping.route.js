...
const { shoppingController: controller } = require('../controllers');
const { shoppingValidation: validation } = require('../validations');
 ...
 * tags:
 *   name: Shoppings
 *   description: Operaciones CRUD para compras a plazo
 */
