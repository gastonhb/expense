...
const { accountStatusController: controller } = require('../controllers');
const { accountStatusValidation: validation } = require('../validations');
 ...
 *   description: Historial mensual de saldos de cuentas
 */
