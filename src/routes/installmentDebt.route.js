...
const { installmentDebtController: controller } = require('../controllers');
const { installmentDebtValidation: validation } = require('../validations');
 ...
 *   description: Operaciones CRUD para deudas en cuotas
 */
