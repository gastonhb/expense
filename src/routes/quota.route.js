...
const { quotaController: controller } = require('../controllers');
const { quotaValidation: validation } = require('../validations');
 ...
 * tags:
 *   name: Quotas
 *   description: Operaciones CRUD para cuotas de compras a plazos
 */
...
router.route('/:id/pay')
  .post(createLimiter, validate(validation.payQuota), controller.payQuota)
  .all(methodNotAllowed);
